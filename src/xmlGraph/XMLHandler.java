...
public class XMLHandler extends DefaultHandler{
	...
	private int CLEAN = 1;
	private int CHECK = 2;
	private String NODEFILE = "data/DBLP/nodes.txt";
	private String EDGEFILE = "data/DBLP/edges.txt";
	private String KEYWORDFILE = "data/DBLP/keywordID.txt";
	private String EDGELABEL = "data/DBLP/edgelabel.txt";
	private String EDGEINFO = "data/DBLP/edgeinfo.txt";
	private String NODECLEANFILE = "data/DBLP/nodeclear.txt";
	private String NODEFORCHECK = "data/DBLP/nodefrocheck.txt";
	private String COMMONFILE = "data/common_words.txt";
	private String ERRORF = "data/DBLP/error.txt";
	private String NODENUM = "data/DBLP/nodenum.txt";
	...
	/*private String AUTHORID = "data/DBLP/authorID.txt";
