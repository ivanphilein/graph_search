...
public class OneReducerBFS extends Reducer<IntWritable,Text,IntWritable,Text>{
	...
	public void reduce(IntWritable key, Iterable<Text> values, Context context) throws InterruptedException, IOException {
		...
		FinalSolutions solution = search.runBestFirstSearch(querySet, topK);
		...
		if(topKSolList!=null){
			...
			while(iterList.hasNext()){
				...
				context.write(new IntWritable(0), new Text(solStr));
			}
		}
	}
